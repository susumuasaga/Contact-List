...
var routes = [
    { path: '', component: _contacts_contacts_component__WEBPACK_IMPORTED_MODULE_2__["ContactsComponent"] },
    { path: 'contactDetails/:id', component: _contact_details_contact_details_component__WEBPACK_IMPORTED_MODULE_3__["ContactDetailsComponent"] },
    { path: 'contactDetails', component: _contact_details_contact_details_component__WEBPACK_IMPORTED_MODULE_3__["ContactDetailsComponent"] },
];
...
var ContactService = /** @class */ (function () {
    ...
    ContactService.prototype.getContacts = function () {
        return this.http.get('/api/contacts')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getContacts', null)))
            .toPromise();
    };
